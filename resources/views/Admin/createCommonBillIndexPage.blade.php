@include('Dashboard.dashboardheader')
  ...
  <main id="main" class="main">
        ...
        <nav>
            ...
            <li class="breadcrumb-item"><a href="{{route('tenantsAssignIndex')}}">Common Bill</a></li>
            <li class="breadcrumb-item active">Create Common Bill</li>
            </ol>
        </nav>
        </div>
            ...
            <div class="card-body">
               ...
               @if(session('success'))
                ...
                @endif
                  ...
                  <form action="{{route('storeCommonBill')}}" method="post" enctype="multipart/form-data" class="row g-12">
                  @csrf
                   
                  
                  <div class="col-md-6">
                  <label for="inputName5" class="form-label">Bill Month</label>
                  <select class="form-control" name="bilmonth">
              ...
              @endif
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="elPrice" name="elPrice">
                </div>
