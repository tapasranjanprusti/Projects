@include('Dashboard.dashboardheader')
  ...
  <main id="main" class="main">
    ...
    @endif
        <div class="col-lg-12">
        <a href="{{route('createSetPrice')}}" class="btn btn-primary" style="float: right;width:154px;margin-bottom: 17px;">Create Price</a>
        </div>
            <div class="col-lg-12">
                ...
                @php 
                  ...
                  <tr>
                    ...
                    <td>  <a href="{{ route('editOffice', ['id' => $price->id]) }}" >
                      ...
                      <a href="{{ route('truncatePriceSet', ['id' => $price->id]) }}" class="delete-btn">
